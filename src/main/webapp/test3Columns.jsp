...
<tiles:insertTemplate template="/layouts/columnLayout.jsp" flush="true">
  ...
  <tiles:putAttribute name="tab" type="string" value="music" />
  ...
  <tiles:putAttribute name="adverts" type="string">

    <h2>Adverts</h2>
    <p>
      This is where google adverts, my adverts and badverts, as well as asides, such as the wiki's plugin index.
    </p>
